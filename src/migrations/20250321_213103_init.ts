...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum_pages_blocks_content_list_size') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum_pages_blocks_content_list_link_type') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum_pages_blocks_content_list_link_appearance') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum_pages_blocks_content_variant') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum_pages_blocks_faq_block_links_link_type') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum_pages_blocks_faq_block_links_link_appearance') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_blocks_content_list_size') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_blocks_content_list_link_type') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_blocks_content_list_link_appearance') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_blocks_content_variant') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_blocks_faq_block_links_link_type') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_blocks_faq_block_links_link_appearance') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__pages_v_published_locale') THEN
    ...
    DO $$ 
    BEGIN
      IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'enum__posts_v_published_locale') THEN
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"size" "enum_pages_blocks_content_list_size" DEFAULT 'oneThird',
  	"icon" varchar,
  	"tag" varchar,
  	"heading" varchar,
  	"content" jsonb,
  	"media_id" integer,
  	"link_type" "enum_pages_blocks_content_list_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum_pages_blocks_content_list_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_content_list_locales" (
  	"link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant" "enum_pages_blocks_content_variant" DEFAULT '1',
  	"rich_text" jsonb,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_faq_block_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_faq_block_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum_pages_blocks_faq_block_links_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_faq_block_links_locales" (
  	"link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_logo_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_pricing_block_base_features_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_pricing_block_additional_features_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_pricing_block" (
  	...
  	"tag" varchar,
  	"rich_text" jsonb,
  	"base_features_tag" varchar,
  	"base_features_heading" varchar,
  	"base_features_content" jsonb,
  	"additional_features_tag" varchar,
  	"additional_features_heading" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_stats_block_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"number" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"size" "enum__pages_v_blocks_content_list_size" DEFAULT 'oneThird',
  	"icon" varchar,
  	"tag" varchar,
  	"heading" varchar,
  	"content" jsonb,
  	"media_id" integer,
  	"link_type" "enum__pages_v_blocks_content_list_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum__pages_v_blocks_content_list_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content_list_locales" (
  	"link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"variant" "enum__pages_v_blocks_content_variant" DEFAULT '1',
  	"rich_text" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_faq_block_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_faq_block_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum__pages_v_blocks_faq_block_links_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_faq_block_links_locales" (
  	"link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_logo_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_pricing_block_base_features_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_pricing_block_additional_features_features" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_stats_block_list" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"number" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_content_list" ADD CONSTRAINT "pages_blocks_content_list_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_content_list" ADD CONSTRAINT "pages_blocks_content_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_content"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_faq_block_links" ADD CONSTRAINT "pages_blocks_faq_block_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_faq_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_faq_block_links_locales" ADD CONSTRAINT "pages_blocks_faq_block_links_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_faq_block_links"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_logo_block" ADD CONSTRAINT "pages_blocks_logo_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_pricing_block_base_features_features" ADD CONSTRAINT "pages_blocks_pricing_block_base_features_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_pricing_block_additional_features_features" ADD CONSTRAINT "pages_blocks_pricing_block_additional_features_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_stats_block_list" ADD CONSTRAINT "pages_blocks_stats_block_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_stats_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_content_list" ADD CONSTRAINT "_pages_v_blocks_content_list_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_content_list" ADD CONSTRAINT "_pages_v_blocks_content_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_content"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_faq_block_links" ADD CONSTRAINT "_pages_v_blocks_faq_block_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_faq_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_faq_block_links_locales" ADD CONSTRAINT "_pages_v_blocks_faq_block_links_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_faq_block_links"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_logo_block" ADD CONSTRAINT "_pages_v_blocks_logo_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_pricing_block_base_features_features" ADD CONSTRAINT "_pages_v_blocks_pricing_block_base_features_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_pricing_block_additional_features_features" ADD CONSTRAINT "_pages_v_blocks_pricing_block_additional_features_features_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pricing_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_stats_block_list" ADD CONSTRAINT "_pages_v_blocks_stats_block_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_stats_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_list_order_idx" ON "pages_blocks_content_list" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_list_parent_id_idx" ON "pages_blocks_content_list" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_content_list_media_idx" ON "pages_blocks_content_list" USING btree ("media_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "pages_blocks_content_list_locales_locale_parent_id_unique" ON "pages_blocks_content_list_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_faq_block_links_order_idx" ON "pages_blocks_faq_block_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_faq_block_links_parent_id_idx" ON "pages_blocks_faq_block_links" USING btree ("_parent_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "pages_blocks_faq_block_links_locales_locale_parent_id_unique" ON "pages_blocks_faq_block_links_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_logo_block_order_idx" ON "pages_blocks_logo_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_logo_block_parent_id_idx" ON "pages_blocks_logo_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_logo_block_path_idx" ON "pages_blocks_logo_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_pricing_block_base_features_features_order_idx" ON "pages_blocks_pricing_block_base_features_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_pricing_block_base_features_features_parent_id_idx" ON "pages_blocks_pricing_block_base_features_features" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_pricing_block_additional_features_features_order_idx" ON "pages_blocks_pricing_block_additional_features_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_pricing_block_additional_features_features_parent_id_idx" ON "pages_blocks_pricing_block_additional_features_features" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_stats_block_list_order_idx" ON "pages_blocks_stats_block_list" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_stats_block_list_parent_id_idx" ON "pages_blocks_stats_block_list" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_list_order_idx" ON "_pages_v_blocks_content_list" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_list_parent_id_idx" ON "_pages_v_blocks_content_list" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_content_list_media_idx" ON "_pages_v_blocks_content_list" USING btree ("media_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "_pages_v_blocks_content_list_locales_locale_parent_id_unique" ON "_pages_v_blocks_content_list_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_faq_block_links_order_idx" ON "_pages_v_blocks_faq_block_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_faq_block_links_parent_id_idx" ON "_pages_v_blocks_faq_block_links" USING btree ("_parent_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "_pages_v_blocks_faq_block_links_locales_locale_parent_id_unique" ON "_pages_v_blocks_faq_block_links_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_logo_block_order_idx" ON "_pages_v_blocks_logo_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_logo_block_parent_id_idx" ON "_pages_v_blocks_logo_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_logo_block_path_idx" ON "_pages_v_blocks_logo_block" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_pricing_block_base_features_features_order_idx" ON "_pages_v_blocks_pricing_block_base_features_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_pricing_block_base_features_features_parent_id_idx" ON "_pages_v_blocks_pricing_block_base_features_features" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_pricing_block_additional_features_features_order_idx" ON "_pages_v_blocks_pricing_block_additional_features_features" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_pricing_block_additional_features_features_parent_id_idx" ON "_pages_v_blocks_pricing_block_additional_features_features" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_stats_block_list_order_idx" ON "_pages_v_blocks_stats_block_list" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_stats_block_list_parent_id_idx" ON "_pages_v_blocks_stats_block_list" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_faq_block_links" CASCADE;
  DROP TABLE "pages_blocks_faq_block_links_locales" CASCADE;
  DROP TABLE "pages_blocks_faq_block" CASCADE;
  DROP TABLE "pages_blocks_form_block" CASCADE;
  DROP TABLE "pages_blocks_logo_block_list" CASCADE;
  DROP TABLE "pages_blocks_logo_block" CASCADE;
  DROP TABLE "pages_blocks_pricing_block_base_features_features" CASCADE;
  DROP TABLE "pages_blocks_pricing_block_additional_features_features" CASCADE;
  DROP TABLE "pages_blocks_pricing_block" CASCADE;
  DROP TABLE "pages_blocks_media_block" CASCADE;
  DROP TABLE "pages_blocks_stats_block_list" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_faq_block_links" CASCADE;
  DROP TABLE "_pages_v_blocks_faq_block_links_locales" CASCADE;
  DROP TABLE "_pages_v_blocks_faq_block" CASCADE;
  DROP TABLE "_pages_v_blocks_form_block" CASCADE;
  DROP TABLE "_pages_v_blocks_logo_block_list" CASCADE;
  DROP TABLE "_pages_v_blocks_logo_block" CASCADE;
  DROP TABLE "_pages_v_blocks_pricing_block_base_features_features" CASCADE;
  DROP TABLE "_pages_v_blocks_pricing_block_additional_features_features" CASCADE;
  DROP TABLE "_pages_v_blocks_pricing_block" CASCADE;
  DROP TABLE "_pages_v_blocks_media_block" CASCADE;
  DROP TABLE "_pages_v_blocks_stats_block_list" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_content_list_size";
  DROP TYPE "public"."enum_pages_blocks_content_list_link_type";
  DROP TYPE "public"."enum_pages_blocks_content_list_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_content_variant";
  DROP TYPE "public"."enum_pages_blocks_faq_block_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_faq_block_links_link_appearance";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_content_list_size";
  DROP TYPE "public"."enum__pages_v_blocks_content_list_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_content_list_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_content_variant";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_faq_block_links_link_appearance";
